...
def get_db_connection():
    # This will automatically use the correct endpoint from the .env file
    rds_host = os.getenv('RDS_ENDPOINT', 'localhost')

    # Remove port if it's included in the endpoint
    if ':' in rds_host:
